...
export default function Footer() {
  const contact_info = [{ name: "Github", link: "https://github.com/DGUTCA" }];
                ...
                return (
                  <div key={idx}>
                    <Image
                      ...
                      src={`/icons/${data.name.toLowerCase()}.svg`}
                      alt="Logo"
                      width={18}
                      height={18}
                    />
                    <a className="dark:text-gray-400" href={data.link}>
                      {data.name}
                    </a>
                  </div>
                );
